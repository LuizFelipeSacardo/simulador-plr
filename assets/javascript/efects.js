...
let redoButtonPlrEfect = document.querySelector('#form__redo-button');
let redoButtonAnticipationEfect = document.querySelector('#form__redo-button-02');
...
function showAntecipationForm(){
  redoButtonAnticipationEfect.classList.add('hide');
...
function showPlrForm(){
  redoButtonPlrEfect.classList.add('hide');
  resultsSection.classList.add('hide');
